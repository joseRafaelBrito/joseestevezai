        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4 fade-in-up stagger-1">
            ...
            <div className="flex space-x-4">
              <a
                href="https://x.com/estevez_brito"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-red-500 transition-all duration-300 hover:scale-110"
              >
                <Twitter className="text-white" size={16} />
              </a>
              <a
                href="https://www.linkedin.com/in/jose-estevez-502528170/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-red-500 transition-all duration-300 hover:scale-110"
              >
              ...
              <a
                href="https://github.com/joseRafaelBrito"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-red-500 transition-all duration-300 hover:scale-110"
              >
        ...
        <div className="border-t border-slate-700/50 pt-8 fade-in-up stagger-5">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-sm">
              <button className="text-slate-400 hover:text-white transition-all duration-300 hover:scale-105">
                {t("footer.privacy")}
              </button>
              <button className="text-slate-400 hover:text-white transition-all duration-300 hover:scale-105">
                {t("footer.terms")}
